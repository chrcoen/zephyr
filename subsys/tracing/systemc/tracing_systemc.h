#ifndef ZEPHYR_TRACE_SYSTEMC_H
#define ZEPHYR_TRACE_SYSTEMC_H
 ...
 */
#define sys_port_trace_k_thread_create(new_thread) sys_trace_k_thread_create(new_thread)
 ...
 */
#define sys_port_trace_k_thread_busy_wait_enter(usec_to_wait) sys_trace_k_thread_busy_wait_enter(usec_to_wait)
 ...
 * @param thread Thread object
 */
#define sys_port_trace_k_thread_ready(thread) sys_trace_k_thread_ready(thread)

/**
 * @brief Called when a thread is pending
 * @param thread Thread object
 */
#define sys_port_trace_k_thread_pend(thread) sys_trace_k_thread_pend(thread)
...
void sys_trace_k_thread_create(struct k_thread *new_thread);
...
void sys_trace_k_thread_busy_wait_enter(int usec_to_wait);
